...
dich_vu.ten_dich_vu, hop_dong.ngay_lam_hop_dong, hop_dong.ngay_ket_thuc, sum(coalesce(dich_vu.chi_phi_thue,0) + coalesce((hop_dong_chi_tiet.so_luong * dich_vu_di_kem.gia),0)) as tong_tien
from khach_hang
