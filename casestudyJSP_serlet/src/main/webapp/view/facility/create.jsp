...
<div class="container">
    <form method="post" action="/facility?action=create">
        ...
        <div class="mb-3">
            ...
            <select name="facilityTypeId" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
        ...
        <div class="mb-3">
            ...
            <select name="rentTypeId" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
